...
public class FacturaController {
	...
	public String ver(@PathVariable(value = "id") Long id,
		...
		Factura factura = clienteService.fetchFacturaByIdWithClientewhiteItemFacturaWithProducto(id); // clienteService.findFacturaById(id);
	...
	public String eliminar(@PathVariable(value="id") Long id, RedirectAttributes flash, Locale locale) {
		...
		Factura factura = clienteService.findFacuturaById(id);
